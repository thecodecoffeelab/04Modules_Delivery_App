...
import 'package:farm_fresh_user/mainScreens/verify_email_screen.dart';
  ...
  Future<void> formValidation() async
  {
    if(imageXFile == null)
    {
      showDialog(
        ...
        {
          return ErrorDialog(
            message: "Please select your user profile image.",
          );
        }
      );
    }
      ...
      if(passwordController.text == confirmPasswordController.text)
      {
          ...
          showDialog(
            ...
            builder: (c)
            {
              return LoadingDialog(
                message: "Farm Fresh is registering your account & send you an email confirmation",
              );
            }
          );
        ...
        else
        {
          showDialog(
              ...
              {
                return ErrorDialog(
                  message: "Please write the complete required info for your Farm Fresh user registration account.",
                );
              }
          );
        }
  ...
  void authenticateSellerAndSignUp() async
  {
    ...
    if(currentUser != null)
    {
      saveDataToFirestore(currentUser!).then((value) {
        ...
        Route newRoute = MaterialPageRoute(builder: (context) => const VerifyEmailScreen());
