...
import 'package:farm_fresh_user/mainScreens/save_address_screen.dart';
import 'package:farm_fresh_user/models/address.dart';
import 'package:farm_fresh_user/widgets/address_design.dart';
import 'package:farm_fresh_user/widgets/progress_bar.dart';
import 'package:farm_fresh_user/widgets/simple_app_bar.dart';
...
class _AddressScreenState extends State<AddressScreen>
{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: SimpleAppBar(title: "Farm Fresh Fruits & Veggies",),
