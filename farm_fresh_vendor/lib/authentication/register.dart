...
import 'package:farm_fresh_vendor/mainScreens/verify_email_screen.dart';
  ...
  Future<void> formValidation() async
  {
    if(imageXFile == null)
    {
      showDialog(
        ...
        {
          return ErrorDialog(
            message: "Please select your vendor image.",
          );
        }
      );
    }
    else
    {
      if(passwordController.text == confirmPasswordController.text)
      {
          ...
          showDialog(
            ...
            builder: (c)
            {
              return LoadingDialog(
                message: "Farm Fresh is registering your account",
              );
            }
          );
        ...
        else
        {
          showDialog(
              ...
              {
                return ErrorDialog(
                  message: "Please write the complete required info for your Farm Fresh vendor account registration.",
                );
              }
          );
        }
      ...
      else
      {
        showDialog(
            ...
            {
              return ErrorDialog(
                message: "Passwords do not match, please check it out.",
              );
            }
        );
      }
  ...
  void authenticateSellerAndSignUp() async
  {
    ...
    if(currentUser != null)
    {
      saveDataToFirestore(currentUser!).then((value) {
        ...
        Route newRoute = MaterialPageRoute(builder: (c) => const VerifyEmailScreen());
              ...
              child: Column(
                children: [
                  ...
                  CustomTextField(
                    ...
                    hintText: "Farm Fresh Shop Address",
                    isObsecre: false,
                    enabled: true,
                  ),
                  Container(
