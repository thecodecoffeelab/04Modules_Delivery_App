...
import 'package:farmfresh_admin_web_portal/widgets/simple_app_bar.dart';
  ...
  Widget build(BuildContext context)
  {
    Widget displayVerifiedSellersDesign()
    {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text(
                        "Total Earnings".toUpperCase() + " GMD " + allSellers!.docs[i].get("earnings").toString(),
                        style: const TextStyle(
                          fontSize: 15,
                          color: Colors.white,
                          letterSpacing: 3,
      ...
      else
      {
        return const Center(
          child: Text(
            "No Record Found in Farm Fresh database.",
            style: TextStyle(
              fontSize: 30,
            ),
          ),
    ...
    return Scaffold(
      appBar: SimpleAppBar(title: "All Verified Vendors Accounts",),
      body: Center(
        child: Container(
