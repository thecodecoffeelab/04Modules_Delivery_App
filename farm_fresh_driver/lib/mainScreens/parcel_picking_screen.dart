...
import 'package:farm_fresh_driver/mainScreens/parcel_delivering_screen.dart';
import 'package:farm_fresh_driver/maps/map_utils.dart';
            ...
            child: Center(
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: const Center(
                    child: Text(
                      "Order has been Picked: Confirm now!",
