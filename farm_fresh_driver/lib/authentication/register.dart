...
import 'package:farm_fresh_driver/mainScreens/verify_email_screen.dart';
  ...
  Future<void> formValidation() async
  {
    if(imageXFile == null)
    {
      showDialog(
        ...
        {
          return ErrorDialog(
            message: "Please select your driver image.",
          );
        }
      );
    }
      ...
      if(passwordController.text == confirmPasswordController.text)
      {
        ...
        else
        {
          showDialog(
              ...
              {
                return ErrorDialog(
                  message: "Please write the complete required info for Driver registration.",
                );
              }
          );
        }
